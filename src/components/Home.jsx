...
export default function Home({ user }) {
  ...
  return (
    <div className="bg-surface min-h-screen text-primary selection:bg-orange-500/30 overflow-x-hidden">
      <Helmet>
<title>SparkStation | Stop Losing Your Best Leads</title>
        <meta name="description" content="Every customer who buys from you and walks out is a lead you just lost. One tag on your counter changes that." />
        <link rel="canonical" href="https://tap.sparkstation.link/" />
<meta property="og:title" content="SparkStation | Stop Losing Your Best Leads" />
        <meta property="og:description" content="Every customer who buys from you and walks out is a lead you just lost. One tag on your counter changes that." />
      ...
      <section className="relative min-h-screen flex items-center pt-24">
        ...
        <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center relative z-10">
          ...
          >
            ...
            >
              <Sparkles size={14} fill="currentColor" /> Ecommerce tactics for your counter
            </motion.div>
            ...
            >
              Online stores capture every customer. Reviews, emails, return visits — all automatic. Your counter should do the same. One tag. Every job. Set it and forget it.
            </motion.p>
            ...
            >
              ...
              >
                Get a Station <ArrowRight size={16} className="group-hover:translate-x-1 transition-transform" />
              </Link>
              <Link 
                to="/demo"
        ...
        <div className="max-w-7xl mx-auto space-y-24">
          <div className="max-w-3xl space-y-6">
            <h2 className="text-5xl md:text-7xl font-black tracking-tighter uppercase leading-none">
              Your counter.<br/>
              <span className="text-orange-500 italic">Your pixel.</span>
            </h2>
            <p className="text-xl text-secondary font-medium leading-relaxed">
              Online stores track every click, capture every email, and follow up with every customer. Your counter should do the same.
            </p>
          </div>
